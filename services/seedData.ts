...
export const investigationsAndCriminalSeedServices: Service[] = [
    // 1) General Criminal Investigations
    {
        ...
        category: 'investigations-and-criminal',
...
export const corporateAndComplianceSeedServices: Service[] = [
    {
        id: "corporate-governance-framework",
        title: { en: "Corporate Governance Framework Setup", ar: "إعداد إطار الحوكمة المؤسسية" },
        description: { en: "Designing and implementing comprehensive corporate governance frameworks.", ar: "تصميم وتنفيذ أطر شاملة للحوكمة المؤسسية." },
        category: 'corporate-and-compliance',
        subCategory: { en: "Governance", ar: "الحوكمة" },
        icon: "Building2",
        geminiModel: "gemini-2.5-flash",
        formInputs: [{ name: "company_structure", label: { en: "Company Structure", ar: "هيكل الشركة" }, type: "file" }],
        usageCount: 0
    },
    {
        id: "regulatory-compliance-audit",
        title: { en: "Regulatory Compliance Audit", ar: "تدقيق الامتثال التنظيمي" },
        description: { en: "Auditing company operations to ensure compliance with local and international regulations.", ar: "تدقيق عمليات الشركة لضمان الامتثال للأنظمة المحلية والدولية." },
        category: 'corporate-and-compliance',
        subCategory: { en: "Compliance", ar: "الامتثال" },
        icon: "ShieldCheck",
        geminiModel: "gemini-2.5-flash",
        formInputs: [{ name: "audit_areas", label: { en: "Areas to Audit", ar: "مجالات التدقيق" }, type: "textarea" }],
        usageCount: 0
    },
    {
        id: "data-protection-gdpr-compliance",
        title: { en: "Data Protection & Privacy Compliance", ar: "الامتثال لحماية البيانات والخصوصية" },
        description: { en: "Ensuring compliance with data protection laws like GDPR and NDMO.", ar: "ضمان الامتثال لقوانين حماية البيانات مثل اللائحة العامة لحماية البيانات ومكتب إدارة البيانات الوطنية." },
        category: 'corporate-and-compliance',
        subCategory: { en: "Data Privacy", ar: "خصوصية البيانات" },
        icon: "Database",
        geminiModel: "gemini-2.5-flash",
        formInputs: [{ name: "data_policies", label: { en: "Current Data Policies", ar: "سياسات البيانات الحالية" }, type: "file" }],
        usageCount: 0
    }
];
