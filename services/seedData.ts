...
export const corporateAndComplianceSeedServices: Service[] = [
    ...
    {
      id: 'creative-services-placeholder',
      title: { en: 'Creative Service Example', ar: 'مثال خدمة إبداعية' },
      description: { en: 'This is a placeholder for a creative service.', ar: 'هذه خدمة مثال للخدمات الإبداعية.' },
      category: 'creative-services',
      subCategory: { en: 'Creative', ar: 'إبداعي' },
      icon: 'Wand2',
      geminiModel: 'gemini-2.5-flash',
      formInputs: [{ name: "creative_prompt", label: { en: "Creative Prompt", ar: "طلب إبداعي" }, type: "textarea" }],
      usageCount: 0,
    }
];
